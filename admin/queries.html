        ...
        <section class="row m-0 p-0">
            ...
            <div class="col s12 m9 white m-0 p-0" style="height:100vh;overflow:auto">
                ...
                <div class="grey lighten-3">
                    <?php $sql = "SELECT * FROM `queries` ORDER BY `_qid` DESC";
                    require "../php/db.php";
                    $conn =
                        DB::getConnection();
                                ...
                                <?php for ($i = 0; $i <
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo $count > 50 ? '... <a href="javascript:openQuery(\'' . $user['name'] . '\', \'' . htmlentities($user['message']) . '\')">Read more</a>' : ''; ?>
                                        </td>
                                        <td>
                                            <button class="transparent btn-flat circle btn-floating btn-medium tooltipped waves-effect waves-circle waves-dark" onclick="deleteQuery(<?= $user['_qid'] ?>, this)" data-tooltip="Delete"><i class="material-icons black-text lh-5">delete</i></button>
                                        </td>
                                    </tr>
                                </tbody>
                            <?php
